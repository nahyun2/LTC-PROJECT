...
class ImageBackgroundApp(QWidget):
    ...
    def initUI(self):
        ...
        images = ['mirror.png', 'cushion.png', 'pillow.png', 'chair.png', 'blanket.png']
        ...
        for i, (img, text, pos) in enumerate(zip(images, texts, positions)):
            ...
            button.setIcon(QIcon(f'funiture/{img}'))  # 이미지 파일 경로를 넣어주세요
    ...
    def showDetails(self, index):
        ...
        image_paths = [
            'funiture/mirror.png',
            'funiture/cushion.png',
            'funiture/pillow.png',
            'funiture/chair.png',
            'funiture/blanket.png'
        ]
