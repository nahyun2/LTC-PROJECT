...
class ImageBackgroundApp(QWidget):
    ...
    def initUI(self):
        ...
        for i, (img, text, pos) in enumerate(zip(images, texts, positions)):
            ...
            button.setIcon(QIcon(f'cosmetic/{img}'))  # 이미지 파일 경로를 넣어주세요
    ...
    def showDetails(self, index):
        ...
        image_paths = [
            'cosmetic/cosmetic.png',
            'cosmetic/perfume.png',
            'cosmetic/pump_cosmetic.png',
            'cosmetic/stick_cosmetic.png',
            'cosmetic/tube_cosmetic.png'
        ]
